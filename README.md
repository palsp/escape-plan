...
- Multiplayer game
- using express framework with socket.io for the server
- using React framework for the web
...
1. [Docker CE](https://docs.docker.com/install/) (20.10.8 or above)
2. [Docker Compose](https://docs.docker.com/compose/install/) (2.0.0 or above)
